...
$(document).on("live",".imgfile",function(){
...
$("#btn_ImgUpStart").click(function () {
    ...
    for (var i = 0; i < $(".lookimg").length; i++) {
        ...
        // $.ajax({
        //     type: "POST",
        //     url: "www.wechatapi.com/js/",
        //     data: { ' ': IMG_BASE, 'imgFormat': IMG_FOMATE, 'lookIndex': NOWLOOK.index },//图片base64编码，图片格式（当前仅支持jpg,png,jpeg三种），图片对象索引
        //     dataType: "json",
